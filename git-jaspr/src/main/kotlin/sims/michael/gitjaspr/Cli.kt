...
you'll need to re-enable it again.
    ...
    private val remoteBranchPrefix by option()
        ...
        .help { "The prefix to use when encoding unique commit IDs into remote ref names (example: jaspr/" }

    private val remoteNamedStackBranchPrefix by option()
        .default(DEFAULT_REMOTE_NAMED_STACK_BRANCH_PREFIX)
        .help { "The prefix to use when pushing named stacks" } // TODO explain better
    // TODO validate that it doesn't share a common prefix with remoteBranchPrefix
